THEME = {
'Token.Text': {'background':'black', 'foreground':''},
'Token.Text.Whitespace': {'background':'black', 'foreground':''},

'Token.Error': {'background':'black', 'foreground':''},


'Token.Name':{'background':'black', 'foreground':'#FFCCE6'},
'Token.Name.Attribute':{'background':'black', 'foreground':'#00FF00'},

'Token.Name.Builtin':{'background':'black', 'foreground':'#FFCCE6'},
'Token.Name.Builtin.Pseudo':{'background':'black', 'foreground':'#FFCCE6'},

'Token.Name.Class':{'background':'black', 'foreground':'#FFFF99'},
'Token.Name.Constant':{'background':'black', 'foreground':'#FFFF99'},
'Token.Name.Decorator':{'background':'black', 'foreground':'#FFFF99'},
'Token.Name.Entity':{'background':'black', 'foreground':'#FFFF99'},
'Token.Name.Exception':{'background':'black', 'foreground':'#FFFF99'},
'Token.Name.Function':{'background':'black', 'foreground':'#FFFF99'},

'Token.Name.Label':{'background':'black', 'foreground':'#CCFF33'},
'Token.Name.Namespace':{'background':'black', 'foreground':'#CCFF33'},
'Token.Name.Other':{'background':'black', 'foreground':'#CCFF33'},
'Token.Name.Tag':{'background':'black', 'foreground':'#CCFF33'},

'Token.Name.Variable':{'background':'black', 'foreground':'#99FFFF'},
'Token.Name.Variable.Class':{'background':'black', 'foreground':'#99FFFF'},
'Token.Name.Variable.Global':{'background':'black', 'foreground':'#99FFFF'},
...
'Token.Comment.Single':{'background':'black', 'foreground':'#99FFCC'},
'Token.Comment.Special':{'background':'black', 'foreground':'#CC99FF'},


'Token.Literal':{'background':'black', 'foreground':'blue'},
...
'Token.Literal.Number':{'background':'black', 'foreground':'#FFCC00'},
'Token.Literal.Number.Bin':{'background':'black', 'foreground':'#00FFCC'},
'Token.Literal.Number.Float':{'background':'black', 'foreground':'#00FF4D'},
'Token.Literal.Number.Hex':{'background':'black', 'foreground':'#CACAAF'},
'Token.Literal.Number.Integer':{'background':'black', 'foreground':'#999966'},
...
'Token.Generic.Deleted':{'background':'black', 'foreground':'blue'},
'Token.Generic.Emph':{'background':'black', 'foreground':'blue'},
'Token.Generic.Error':{'background':'black', 'foreground':'blue'},
'Token.Generic.Heading':{'background':'black', 'foreground':'blue'},
'Token.Generic.Inserted':{'background':'black', 'foreground':'blue'},
'Token.Generic.Output':{'background':'black', 'foreground':'blue'},
'Token.Generic.Prompt':{'background':'black', 'foreground':'blue'},
'Token.Generic.Strong':{'background':'black', 'foreground':'blue'},
