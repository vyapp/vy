...
Extensible and comfortable vim-like in Python.
...
for all languages that python-pygments supports. It is possible to easily implement new syntax highlighting 
themes that work for all languages because it uses python pygments styles scheme.
...
There are debuggers for several languages. One can set break points, remove break points, 
run the code then see the cursor jumping to the line that is being executed and much more.
